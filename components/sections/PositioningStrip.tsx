...
export default function PositioningStrip({
  text = 'The only center 100% dedicated to Radiation Oncology in Florida — for pet owners seeking answers and for veterinarians looking for a trusted radiation oncology partner.',
